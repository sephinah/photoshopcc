...
/*
@@@BUILDINFO@@@ Upload To SketchFab.jsx 1.0.0.22
 */
/*
...
// Buttons
	...
	dlgMain.btnRun.onClick = function () {
		...
		dlgMain.etHelp.text = "Model uploading...";
...
function requestToken(exportInfo, dlgEmail) {
	saveExportInfo(exportInfo);
	dlgEmail.etHelp.text = "Requesting token...";
...
function UploadToSkectchFab(exportInfo, filePath, dlgMain) {
	...
	dlgMain.etHelp.text = "Model uploading... please Wait";
